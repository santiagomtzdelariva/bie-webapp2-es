<g:set var="orgNameLong" value="${grailsApplication.config.skin.orgNameLong}" scope="request"/>
<g:set var="orgNameShort" value="${grailsApplication.config.skin.orgNameShort}" scope="request"/>
<!DOCTYPE html>
<html>
<head>
